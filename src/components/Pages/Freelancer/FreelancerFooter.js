                ...
                <div className="row">
                    ...
                    <div className="col-lg-4 mb-5 mb-lg-0">
                        ...
                        <a className="btn btn-outline-light btn-social mx-1" href="#!">
                            <svg className="svg-inline--fa fa-facebook-f fa-w-10 fa-fw" aria-hidden="true"
                        ...
                        <a className="btn btn-outline-light btn-social mx-1" href="#!">
                            <svg className="svg-inline--fa fa-linkedin-in fa-w-14 fa-fw" aria-hidden="true"
                        ...
                        <a className="btn btn-outline-light btn-social mx-1" href="#!">
                            <svg className="svg-inline--fa fa-dribbble fa-w-16 fa-fw" aria-hidden="true"
